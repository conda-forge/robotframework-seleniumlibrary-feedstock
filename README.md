About robotframework-seleniumlibrary-feedstock
==============================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotframework-seleniumlibrary-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4300&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotframework-seleniumlibrary-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotframework-seleniumlibrary` can be installed with `conda`:
...
```
mamba install robotframework-seleniumlibrary
```

It is possible to list all of the versions of `robotframework-seleniumlibrary` available on your platform with `conda`:
...
```
mamba search robotframework-seleniumlibrary --channel conda-forge
```
...
mamba repoquery search robotframework-seleniumlibrary --channel conda-forge

# List packages depending on `robotframework-seleniumlibrary`:
mamba repoquery whoneeds robotframework-seleniumlibrary --channel conda-forge

# List dependencies of `robotframework-seleniumlibrary`:
mamba repoquery depends robotframework-seleniumlibrary --channel conda-forge
```
